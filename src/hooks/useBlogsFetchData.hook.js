...
const useBlogsFetchData = (url, componentNameProp) => {
        ...
        setTimeout(() => {
            ...
            fetchBlogsData().catch(error => {
                if (error.name === 'AbortError') {
                    console.log(`fetch Aborted in ${componentNameProp}! React state, can't update on an unmounted component`);
                } else {
